...
from terracotta import utils


CONF = cfg.CONF

_CTX_THREAD_LOCAL_NAME = "TERRACOTTA_APP_CTX_THREAD_LOCAL"
...
class TerracottaContext(BaseContext):
    ...
    def __repr__(self):
        return "TerracottaContext %s" % self.to_dict()
